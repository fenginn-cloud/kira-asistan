...
export const PLANS: Record<PlanId, PlanInfo> = {
  ...
  business: {
    ...
    features: [
      ...
      'Gelişmiş AI destekli analizler',
      'Öncelikli destek',
    ],
...
export const FEATURE_MATRIX: FeatureRow[] = [
  ...
  { label: 'İstatistik ve raporlar', free: false, pro: true, business: true },
  ...
  { label: 'AI destekli öneriler', free: false, pro: true, business: 'Gelişmiş' },
